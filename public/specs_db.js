const IS_4985_SPECS = {
    sizes_db: {
        20:  {"min_od": 20.0,  "max_od": 20.3,  "ovality": 1.0, "socket": 16,  "thickness": {5: [1.5, 1.1, 1.5], 6: [1.8, 1.4, 1.8]}},
        25:  {"min_od": 25.0,  "max_od": 25.3,  "ovality": 1.0, "socket": 19,  "thickness": {4: [1.6, 1.2, 1.6], 5: [1.8, 1.4, 1.8], 6: [2.1, 1.7, 2.1]}},
        32:  {"min_od": 32.0,  "max_od": 32.3,  "ovality": 1.0, "socket": 22,  "thickness": {4: [1.9, 1.5, 1.9], 5: [2.2, 1.8, 2.2], 6: [2.7, 2.2, 2.7]}},
        40:  {"min_od": 40.0,  "max_od": 40.3,  "ovality": 1.0, "socket": 26,  "thickness": {3: [1.8, 1.4, 1.8], 4: [2.2, 1.8, 2.2], 5: [2.7, 2.2, 2.7], 6: [3.3, 2.8, 3.3]}},
        50:  {"min_od": 50.0,  "max_od": 50.3,  "ovality": 1.0, "socket": 31,  "thickness": {3: [2.1, 1.7, 2.1], 4: [2.8, 2.3, 2.8], 5: [3.3, 2.8, 3.3], 6: [4.0, 3.4, 4.0]}},
        63:  {"min_od": 63.0,  "max_od": 63.3,  "ovality": 1.0, "socket": 38,  "thickness": {2: [1.9, 1.5, 1.9], 3: [2.7, 2.2, 2.7], 4: [3.3, 2.8, 3.3], 5: [4.1, 3.5, 4.1], 6: [5.0, 4.3, 5.0]}},
        75:  {"min_od": 75.0,  "max_od": 75.3,  "ovality": 1.0, "socket": 44,  "thickness": {2: [2.2, 1.8, 2.2], 3: [3.1, 2.6, 3.1], 4: [4.0, 3.4, 4.0], 5: [4.9, 4.2, 4.9], 6: [5.9, 5.1, 5.9]}},
        90:  {"min_od": 90.0,  "max_od": 90.3,  "ovality": 1.2, "socket": 51,  "thickness": {1: [1.7, 1.3, 1.7], 2: [2.6, 2.1, 2.6], 3: [3.7, 3.1, 3.7], 4: [4.6, 4.0, 4.6], 5: [5.7, 5.0, 5.7], 6: [7.0, 6.1, 7.1]}},
        110: {"min_od": 110.0, "max_od": 110.4, "ovality": 1.4, "socket": 61,  "thickness": {1: [2.0, 1.6, 2.0], 2: [3.0, 2.5, 3.0], 3: [4.3, 3.7, 4.3], 4: [5.6, 4.9, 5.6], 5: [7.0, 6.1, 7.1], 6: [8.5, 7.5, 8.7]}},
        125: {"min_od": 125.0, "max_od": 125.4, "ovality": 1.5, "socket": 69,  "thickness": {1: [2.2, 1.8, 2.2], 2: [3.4, 2.9, 3.4], 3: [5.0, 4.3, 5.0], 4: [6.4, 5.6, 6.4], 5: [7.8, 6.9, 8.0], 6: [9.6, 8.5, 9.8]}},
        140: {"min_od": 140.0, "max_od": 140.5, "ovality": 1.7, "socket": 76,  "thickness": {1: [2.4, 2.0, 2.4], 2: [3.8, 3.2, 3.8], 3: [5.5, 4.8, 5.5], 4: [7.2, 6.3, 7.3], 5: [8.7, 7.7, 8.9], 6: [10.7, 9.5, 11.0]}},
        160: {"min_od": 160.0, "max_od": 160.5, "ovality": 2.0, "socket": 86,  "thickness": {1: [2.8, 2.3, 2.8], 2: [4.3, 3.7, 4.3], 3: [6.2, 5.4, 6.2], 4: [8.2, 7.2, 8.3], 5: [9.9, 8.8, 10.2], 6: [12.2, 10.9, 12.6]}},
        180: {"min_od": 180.0, "max_od": 180.6, "ovality": 2.2, "socket": 96,  "thickness": {1: [3.1, 2.6, 3.1], 2: [4.9, 4.2, 4.9], 3: [7.0, 6.1, 7.1], 4: [9.0, 8.0, 9.2], 5: [11.1, 9.9, 11.4], 6: [13.7, 12.2, 14.1]}},
        200: {"min_od": 200.0, "max_od": 200.6, "ovality": 2.4, "socket": 106, "thickness": {1: [3.4, 2.9, 3.4], 2: [5.3, 4.6, 5.3], 3: [7.7, 6.8, 7.9], 4: [10.0, 8.9, 10.3], 5: [12.3, 11.0, 12.7], 6: [15.2, 13.6, 15.7]}},
        225: {"min_od": 225.0, "max_od": 225.7, "ovality": 2.7, "socket": 119, "thickness": {1: [3.9, 3.3, 3.9], 2: [6.0, 5.2, 6.0], 3: [8.6, 7.6, 8.8], 4: [11.2, 10.0, 11.5], 5: [13.9, 12.4, 14.3], 6: [17.1, 15.3, 17.6]}},
        250: {"min_od": 250.0, "max_od": 250.8, "ovality": 3.0, "socket": 131, "thickness": {1: [4.2, 3.6, 4.2], 2: [6.5, 5.7, 6.5], 3: [9.6, 8.5, 9.8], 4: [12.6, 11.2, 12.9], 5: [15.4, 13.8, 15.9], 6: [18.9, 17.0, 19.6]}},
        280: {"min_od": 280.0, "max_od": 280.9, "ovality": 3.4, "socket": 146, "thickness": {1: [4.8, 4.1, 4.8], 2: [7.3, 6.4, 7.4], 3: [10.7, 9.5, 11.0], 4: [14.0, 12.5, 14.4], 5: [17.2, 15.4, 17.8], 6: [21.1, 19.0, 21.9]}},
        315: {"min_od": 315.0, "max_od": 316.0, "ovality": 3.8, "socket": 164, "thickness": {1: [5.3, 4.6, 5.3], 2: [8.2, 7.2, 8.3], 3: [12.0, 10.7, 12.4], 4: [15.6, 14.0, 16.1], 5: [19.3, 17.3, 19.9], 6: [23.8, 21.4, 24.7]}},
        355: {"min_od": 355.0, "max_od": 356.1, "ovality": 4.3, "socket": 184, "thickness": {1: [5.9, 5.1, 5.9], 2: [9.2, 8.1, 9.4], 3: [13.4, 12.0, 13.8], 4: [17.6, 15.8, 18.2], 5: [21.8, 19.6, 22.6], 6: [26.8, 24.1, 27.8]}},
        400: {"min_od": 400.0, "max_od": 401.2, "ovality": 4.8, "socket": 206, "thickness": {1: [6.6, 5.8, 6.7], 2: [10.3, 9.1, 10.5], 3: [15.1, 13.5, 15.6], 4: [19.8, 17.8, 20.5], 5: [24.4, 22.0, 25.4]}},
        450: {"min_od": 450.0, "max_od": 451.4, "ovality": 5.4, "socket": 231, "thickness": {1: [7.4, 6.5, 7.5], 2: [11.6, 10.3, 11.9], 3: [17.0, 15.2, 17.5], 4: [22.2, 20.0, 23.0], 5: [27.5, 24.7, 28.5]}},
        500: {"min_od": 500.0, "max_od": 501.5, "ovality": 6.0, "socket": 256, "thickness": {1: [8.2, 7.2, 8.3], 2: [12.8, 11.4, 13.2], 3: [18.8, 16.9, 19.5], 4: [24.8, 22.3, 25.7], 5: [30.5, 27.5, 31.7]}},
        560: {"min_od": 560.0, "max_od": 561.7, "ovality": 6.8, "socket": 286, "thickness": {1: [9.2, 8.1, 9.4], 2: [14.3, 12.8, 14.8], 3: [21.0, 18.9, 21.8], 4: [27.6, 24.9, 28.7], 5: [34.1, 30.7, 35.4]}},
        630: {"min_od": 630.0, "max_od": 631.9, "ovality": 7.6, "socket": 321, "thickness": {1: [10.3, 9.1, 10.5], 2: [16.1, 14.4, 16.6], 3: [23.7, 21.3, 24.5], 4: [31.0, 28.0, 32.2], 5: [38.4, 34.6, 39.8]}}
    },
    ...
    generateTestParameters: function(size, pipeClass, pipeType, isPlumbing) {
        ...
        const min_od_any = (size) ? (size * 0.987).toFixed(1) : "";
        const max_od_any = (size) ? (size * 1.013).toFixed(1) : "";
        ...
        return [
            ...
            // Row 20
            { clause: "7.1.2.1", param: "DIMENSIONS-PIPE-Average Thickness", spec_val: `${t_max}mm`, type: "Quantitative", expected: "", min: "", max: t_max }, 
            // Row 21
